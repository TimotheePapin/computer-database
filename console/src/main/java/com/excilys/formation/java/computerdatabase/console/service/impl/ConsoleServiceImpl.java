...
public class ConsoleServiceImpl implements ConsoleService {
	...
	public List<ComputerDTO> getAllComputer() {
		...
		return Client.create().resource(COMPUTER + "/getAll")
	...
	public List<Company> getAllCompany() {
		...
		return Client.create().resource(COMPANY + "/getAll")
				.type(MediaType.APPLICATION_XML).get(ClientResponse.class)
	...
	public ComputerDTO getComputerById(int id) {
		...
		return Client.create().resource(COMPUTER + "/getById" + "/" + id)
	...
	public ComputerDTO createComputer(Computer computer) {
		...
		return Client.create().resource(COMPUTER + "/create")
				.accept(MediaType.APPLICATION_XML)
				.type(MediaType.APPLICATION_XML).entity(computerDTO)
	...
	public ComputerDTO updateComputer(Computer computer) {
		...
		ComputerDTO computerDTO = MapComputer.computerToDTO(computer);
		return Client.create().resource(COMPUTER + "/update")
				.accept(MediaType.APPLICATION_XML)
				.type(MediaType.APPLICATION_XML).entity(computerDTO)
				.post(ClientResponse.class)
				.getEntity(new GenericType<ComputerDTO>() {
	...
	public void deleteComputer(int id) {
		...
		Client.create().resource(COMPUTER + "/delete/" + id)
	...
	public void deleteCompany(int id) {
		...
		Client.create().resource(COMPANY + "/delete/" + id)
				.header("Content-Type", "application/xml")
				.delete(ClientResponse.class);
	}
